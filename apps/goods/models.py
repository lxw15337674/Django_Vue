...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name='内容	', width=600, height=300, toolbars="full", imagePath="goods/images/",
    ...
    goods_front_image_url = models.CharField(max_length=300, default="", verbose_name="封面图片地址")
